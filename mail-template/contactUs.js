  ...
  return `<!DOCTYPE html>
      ...
      <body>
          <div class="container">
              ...
              <div class="message">Contact Us Confirmation</div>
              <div class="body">
                  <p>Dear ${name},</p>
                  <p>This is a quick mail to say we've received your mail!</p>
                  <p>Our support team will get back to you as soon as possible.
                  </p>
              </div>
  ...
  return `<!DOCTYPE html>
          ...
          <body>
              <div class="container">
                  <a href=""><img class="logo" src="https://i.ibb.co/7Xyj3PC/logo.png"
                          alt="StudyNotion Logo"></a>
                  <div class="message">Contact Us from : ${email}</div>
                  <div class="body">
                      <p>Name : ${name},</p>
                      <p>Message : ${message}</p>
